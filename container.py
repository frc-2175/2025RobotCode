...
from swervepy.impl import CoaxialSwerveModule, SparkMaxEncoderType
        ...
        modules = (
            ...
            CoaxialSwerveModule(
                ...
                azimuth=components.azimuth_component_class(
                    ...
                    absolute_encoder=components.absolute_encoder_class(self._controller, SparkMaxEncoderType.PWM),
                ),
